...
export function createDemoResetState(): {
  ...
  const vehicles: Vehicle[] = [
    { id: "EV-4712", spotId: "P2-15", model: "Polestar 2", paint: "white", battery: 76, status: "parked", assignedRobotId: null, requestedEnergyKwh: null, priority: "Normal", position: { x: 18, y: 16 }, targetBattery: 80, route: [], routeIndex: 0, heading: 0, arrivalTick: 0, expectedDepartureTick: 14000 },
    { id: "EV-4821", spotId: "P2-18", model: "Hyundai IONIQ 5", paint: "charcoal", battery: 18, status: "parked", assignedRobotId: null, requestedEnergyKwh: 28, priority: "Urgent", position: { x: 45, y: 16 }, targetBattery: 80, route: [], routeIndex: 0, heading: 0, arrivalTick: 0, expectedDepartureTick: 12000 },
    { id: "EV-2054", spotId: "P2-20", model: "Tesla Model 3", paint: "black", battery: 64, status: "parked", assignedRobotId: null, requestedEnergyKwh: null, priority: "Normal", position: { x: 54, y: 16 }, targetBattery: 70, route: [], routeIndex: 0, heading: 0, arrivalTick: 0, expectedDepartureTick: 13000 },
    { id: "EV-7391", spotId: "P2-22", model: "Kia EV6", paint: "white", battery: 88, status: "parked", assignedRobotId: null, requestedEnergyKwh: null, priority: "Normal", position: { x: 72, y: 16 }, targetBattery: 90, route: [], routeIndex: 0, heading: 0, arrivalTick: 0, expectedDepartureTick: 15000 },
